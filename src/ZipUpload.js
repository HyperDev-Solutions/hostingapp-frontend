...
const ZipUpload = ({ setToast, setErrorMessage }) => {
  ...
  return (
    <>
      ...
      <div className=" flex flex-col items-center p-8 border-dashed border-2 border-gray-[#fafafa] text-gray-500  rounded-xl bg-[#fafafa]">
        ...
        {filename && url ? (
          <div className="flex items-center gap-x-4 ">
            <h1>
              <a className="text-blue-400   text-xs lg:text-base " href={url}>
                {" "}
                {url}{" "}
              </a>
            </h1>
      ...
      <button
        onClick={handleClick}
        className="text-white hover:text-white border  border-gray-400 hover:bg-blue-600 bg-blue-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-base text-center mr-2 mb-2 mt-4 w-full py-2 px-2"
      >
        Upload
      </button>
    </>
