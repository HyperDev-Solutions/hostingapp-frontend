    ...
    <div className=" flex flex-col items-center p-8 border-dashed border-2 border-gray-[#fafafa] text-gray-500  rounded-xl bg-[#fafafa]">
     ...
     <a className="text-blue-400   text-xs lg:text-base " href={url}>  {url} </a>
       ...
       onClick={(e)=>setURL(false)}
        type="button" 
        className=" ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-full focus:ring-2 focus:ring-gray-300 p-1 hover:bg-gray-100 " data-dismiss-target="#toast-danger" aria-label="Close">
